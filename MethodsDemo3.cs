...
namespace Lokesh
{
    class MethodsDemo3
    {
        static void Main()
        {
            ...
            //Calculator: Using + symbol we can add int values/ decimal values (float(32-bit precision)/ double(64-bit precision)/ decimal(128-bit precision)). Internally it is calling different methods based on the i/p values (Integer or decimal).
